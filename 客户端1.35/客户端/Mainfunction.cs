...
namespace 客户端
{
    ...
    public partial class Mainfunction : Form
    {
        ...
        private void Mainfunction_Load(object sender, EventArgs e)
        {
            ...
            if (Login.permession > 1)
                pictureBox33.Visible = true;
            if (Login.permession > 2)
                pictureBox32.Visible = true;
            if (Login.permession > 3)
        ...
        {
            Changeproductinfo frm2 = new Changeproductinfo();
            frm2.Show();
        }
        ...
        {
            Setinnercode frm10 = new Setinnercode();
            frm10.Show();
        }

        private void pictureBox30_Click(object sender, EventArgs e)
        {
            Peoplemanagement frm9 = new Peoplemanagement();
            frm9.Show();
        }
    }
}
