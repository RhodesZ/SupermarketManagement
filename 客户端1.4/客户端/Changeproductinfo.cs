...
namespace 客户端
{
    public partial class Changeproductinfo : Form
    {
        ...
        public string searchcommannd()
        {
            ...
            if (idnumber.Text != "")
                command = command + "id=" + idnumber.Text + " and ";
            if (name.Text != "")
        ...
        {
            if(isnumber(idnumber.Text)==false)
            {
                Message msg = new Message("");
        ...
        private void changebutton_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count == 1)
            {
                ...
                idnumber.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
        ...
        private void 另存在数据ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Save();
        }
