...
namespace 客户端
{
    public partial class Login : Form
    {
        ...
        private string Code = "";//可以修改为自己想要的Code
        int temp = 0;
        ...
        {
            string sql = string.Format("select * from innercode where id=1");
        ...
        private void regbutton_Click(object sender, EventArgs e)
        {
            if (checkcode()==true)
            {
                ...
                else
                {
                    ...
                    String InsertNewComm = string.Format("INSERT INTO userinfo(name,password,permission,salary) VALUES('{0}','{1}','{2}','{3}')", account.Text, Login.GetSHA1(password.Text),4,3000);
